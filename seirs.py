...
def create_SEIRS_simulation(width=500, height=500, number_of_people=5000, num_infected=50, infect_rate=0.8,
    ...
    while (len(infected) > 0 or len(exposed) > 0) and step_count <= max_days:
        ...
        pygame.image.save(screen, "frames/" + simulation_name + '_SEIRS.png')
    ...
    # Save simulation GIF
    simulation_gif_path = f"simulations/{simulation_name}_SEIRS.gif"
    ...
    graph_gif_path = f"graphs/{simulation_name}_SEIRS_graph.gif"
